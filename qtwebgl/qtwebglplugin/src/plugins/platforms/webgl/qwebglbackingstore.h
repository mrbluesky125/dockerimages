...
#ifndef QWEBGLBACKINGSTORE_H
#define QWEBGLBACKINGSTORE_H
...
class QWebGLBackingStore : public QPlatformBackingStore
{
public:
    QWebGLBackingStore(QWindow *window);
    ~QWebGLBackingStore();
